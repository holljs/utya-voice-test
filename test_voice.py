...
kolobok_phrases = {
    ...
    "kb_step6_q.wav": "Лиси́чка закружи́лась в та́нце, а Уутя вернуулся домо́й к ба́бушке и де́душке! Они́ так обра́довались, что реши́ли устро́ить сюрпри́з! Что же вы́брать: вкуусные бли́нчики и́ли пенную вечери́нку с ууточками?",
