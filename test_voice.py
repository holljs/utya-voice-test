...
Огурцы́ и кабачки́и.
Вы́ырастет ли там мопе́ед?
Захохо́очем гро́мко:!!""",

    # ✅ Ответ ДА
    "yesno_walk.wav": """Мы наде́енем босоно́ожки,
Побежии́м мы по доро́жке!
...
Ска́жем хо́ром сло́ово!!""",
    ...
    "yesno_hands.wav": """Мы испа́чкали ладо́ошки,
Пока́ пры́ыгали немно́ожко.
