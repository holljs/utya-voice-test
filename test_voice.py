...
quiz_phrases = {
    ...
    "chain_story_5.wav": "Лиса́ отдала́ ко́сть а соба́ака подари́ла ей большо́ой жёолудь.",
    "chain_story_6.wav": "Лиса́ расколо́ла жёлудь а внутри́ оказа́лся густо́ой сла́адкий мёоод!",
