...
phrases = {
    "wind_intro.wav": "Сыграем в ветерóк! Поду́й на вертушку что есть си́лы!",
    "wind_good.wav": "Огó, как крýтится! Ты настоя́щий урагáн!",
    "wind_more.wav": "Поду́й ещё сильне́е!"
}
